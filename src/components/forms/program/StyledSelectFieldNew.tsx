...
const StyledSelectFieldNew = ({ field, required = false, value, onChange, formData }: { field: FormField; required?: boolean; value: string; onChange: (arg0: React.ChangeEvent<HTMLSelectElement>) => void; formData?: any; }) => {
