...
const UserInfo = ({ user }: { user?: User | null }) => (
    <>
        <div className="mb-2" id="form-customer-name">
            ...
            <input type="text" name="fullname" id="fullname" className="input" readOnly={user ? true : false} value={user?.full_name || ''} />
        </div>
        <div className="mb-2" id="form-customer-phone">
            ...
            <input type="number" name="phone" id="phone" className="input" readOnly={user ? true : false} value={user?.phone_number || ''} />
        </div>
    </>
);
