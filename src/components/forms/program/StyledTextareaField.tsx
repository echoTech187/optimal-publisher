...
const StyledTextareaField = ({ field, required = false, value, onChange, errors }: { field: FormField; required?: boolean; value?: string; onChange?: (arg0: React.ChangeEvent<HTMLTextAreaElement>) => void; errors: any; }) => (
    <>
