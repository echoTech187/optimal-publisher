...
export default function Contact() {
    return (<>
        <div className="" id='contacts'>
            <div className='text-center container  h-54  p-12 bg-purple-800 max-md:rounded-none rounded-lg w-full  mx-auto text-white'>
                <h1 className="text-xl md:text-2xl font-semibold mb-6">Anda memiliki pertanyaan tentang kami?</h1>
