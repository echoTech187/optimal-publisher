                ...
                <div className="max-w-[1300px] mx-auto h-full">
                    ...
                    <div className="flex items-center h-full w-full gap-12 py-12">
                        ...
                        <div className="flex-1">
                            ...
                            <button className="flex items-center justify-between gap-6 mt-12 py-3 px-6 rounded-md transition-colors bg-yellow-400 text-black font-semibold hover:bg-yellow-700 hover:text-white">
                ...
                <div className="max-w-[1300px] mx-auto h-full">
                    <div className="flex items-center h-full w-full gap-12 py-12">
                        ...
                        <div className="flex-1">
                            ...
                            <button className="flex items-center justify-between gap-6 mt-12 py-3 px-6 rounded-md transition-colors bg-black/90 backdrop-blur-3xl text-white font-semibold hover:bg-yellow-700 hover:text-white">
                                <span className="flex items-center gap-2">
                                    Publikasikan
                                </span>
                                <Icon icon="tabler:arrow-right" className="size-6" width="32" height="32" />
