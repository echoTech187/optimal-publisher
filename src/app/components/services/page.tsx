                ...
                <div className="max-w-[1300px] mx-auto h-full">
                    ...
                    <div className="flex items-center h-full w-full gap-12 py-12">
                        ...
                        <div className="flex-1">
                            ...
                            <button  onClick={()=> window.open("/auth?type=isbn", "_parent")} className="flex items-center justify-between gap-6 mt-12 py-3 px-6 rounded-md transition-colors bg-yellow-400 text-black font-semibold hover:bg-yellow-700 hover:text-white">
