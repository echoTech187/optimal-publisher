            ...
            <div className="flex items-center justify-start sm:justify-between w-full max-w-[1300px] mx-auto px-4 2xl:px-0">
                ...
                <MenuNavigation isVisible={isVisible} />
                 ...
                 <div className="md:flex items-center space-x-4 hidden">
                    <button onClick={() => window.open('/auth/register', '_blank')} className="py-2 px-4 rounded-md transition-colors border font-semibold border-orange-400 text-black dark:text-orange-400 hover:bg-gray-900 hover:border-gray-900 hover:text-orange-400">
                        Daftar
                    </button>
                    <button onClick={() => window.open('/auth', '_blank')} className={`py-2 px-4 rounded-md transition-colors font-semibold border ${isVisible ? 'bg-orange-400 border-orange-400 text-black' : 'bg-orange-400 border-orange-400 text-black'} hover:bg-gray-900 hover:border-gray-900 hover:text-orange-400`}>
                        Masuk
                    </button>
                </div>
                {/* <div className="px-4">
