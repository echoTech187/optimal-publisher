...
export default function PackageList() {
    ...
    return (
        <section className="w-full h-full py-[150px]">
            ...
            <header className={`max-w-[1300px] mx-auto px-4 text-center ${(type === "pm") ? "hidden" : ""}`}>
            ...
            <div className={`max-w-[1300px] mx-auto px-4 mt-12 ${(type === "pm") ? "hidden" : ""}`}>
                {
                    (type === "mbm") ?
                        <>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="flex flex-col rounded-xl shadow-xs bg-gradient-to-b from-[#ffeaa4] to-white dark:from-[#111] dark:to-[#333] dark:text-gray-50 text-[#333] hover:shadow-2xl hover:shadow-black/20 backdrop-blur-md">
                                    <div className="flex items-center gap-2 text-xl p-6">
                                        ...
                                        <div>
                                            ...
                                            <h5 className="font-bold">Paket 5 Anggota</h5>
                                        </div>
                                    </div>
                                    <div className=" w-full px-6 flex-1">
                                        <p className="text-sm">Paket 5 Anggota</p>
                                    </div>
                                    <div className="flex justify-between items-center p-6">
                                        <div className="flex justify-center">
                                            <span className="text-black dark:text-gray-50 font-bold">Rp. 899.000/Monograf</span>
                                        </div>
                                        <button onClick={() => showFormCustomer("5", "Paket 5 Anggota.")} className="w-fit font-bold py-2 px-4 rounded transition-colors bg-black dark:bg-black/80 dark:text-amber-500 dark:hover:text-amber-400 text-white hover:font-semibold text-sm hover:bg-transparent border border-transparent hover:border-black hover:text-black flex items-center justify-center">
                                            Pilih Paket
                                        </button>
                                    </div>
                                </div>
                                <div className="flex flex-col rounded-xl shadow-xs bg-gradient-to-b from-[#ffeaa4] to-white dark:from-[#111] dark:to-[#333] dark:text-gray-50 text-[#333] hover:shadow-2xl hover:shadow-black/20 backdrop-blur-md">
                                    <div className="flex items-center gap-2 text-xl p-6">
                                        ...
                                        <div>
                                            <p className="text-sm">Anggota</p>
                                            <h5 className="font-bold">Paket 4 Anggota</h5>
                                        </div>
                                    </div>
                                    <div className=" w-full px-6 flex-1">
                                        <p className="text-sm">Paket 4 Anggota</p>
                                    </div>
                                    <div className="flex justify-between items-center p-6">
                                        <div className="flex justify-center">
                                            <span className="text-black dark:text-gray-50 font-bold">Rp. 799.000/Monograf</span>
                                        </div>
                                        <button onClick={() => showFormCustomer("4", "Paket 4 Anggota.")} className="w-fit font-bold py-2 px-4 rounded transition-colors bg-black dark:bg-black/80 dark:text-amber-500 dark:hover:text-amber-400 text-white hover:font-semibold text-sm hover:bg-transparent border border-transparent hover:border-black hover:text-black flex items-center justify-center">
                                            Pilih Paket
                                        </button>
                                    </div>
                                </div>
                                <div className="flex flex-col rounded-xl shadow-xs bg-gradient-to-b from-[#ffeaa4] to-white dark:from-[#111] dark:to-[#333] dark:text-gray-50 text-[#333] hover:shadow-2xl hover:shadow-black/20 backdrop-blur-md">
                                    <div className="flex items-center gap-2 text-xl p-6">
                                        ...
                                        <div>
                                            <p className="text-sm">Anggota</p>
                                            <h5 className="font-bold">Paket 3 Anggota</h5>
                                        </div>
                                    </div>
                                    <div className=" w-full px-6 flex-1">
                                        <p className="text-sm">Paket 3 Anggota.</p>
                                    </div>
                                    <div className="flex justify-between items-center p-6">
                                        <div className="flex justify-center">
                                            <span className="text-black dark:text-gray-50 font-bold">Rp. 749.000/Monograf</span>
                                        </div>
                                        <button onClick={() => showFormCustomer("3", "Paket 3 Anggota.")} className="w-fit font-bold py-2 px-4 rounded transition-colors bg-black dark:bg-black/80 dark:text-amber-500 dark:hover:text-amber-400 text-white hover:font-semibold text-sm hover:bg-transparent border border-transparent hover:border-black hover:text-black flex items-center justify-center">
                                            Pilih Paket
                                        </button>
                                    </div>
                                </div>
                                <div className="flex flex-col rounded-xl shadow-xs bg-gradient-to-b from-[#ffeaa4] to-white dark:from-[#111] dark:to-[#333] dark:text-gray-50 text-[#333] hover:shadow-2xl hover:shadow-black/20 backdrop-blur-md">
                                    <div className="flex items-center gap-2 text-xl p-6">
                                        ...
                                        <div>
                                            <p className="text-sm">Anggota</p>
                                            <h5 className="font-bold">Paket 2 Anggota</h5>
                                        </div>
                                    </div>
                                    <div className=" w-full px-6 flex-1">
                                        <p className="text-sm">Paket 2 Anggota.</p>
                                    </div>
                                    <div className="flex justify-between items-center p-6">
                                        <div className="flex justify-center">
                                            <span className="text-black dark:text-gray-50 font-bold">Rp. 949.000/Monograf</span>
                                        </div>
                                        <button onClick={() => showFormCustomer("2", "Paket 2 Anggota.")} className="w-fit font-bold py-2 px-4 rounded transition-colors bg-black dark:bg-black/80 dark:text-amber-500 dark:hover:text-amber-400 text-white hover:font-semibold text-sm hover:bg-transparent border border-transparent hover:border-black hover:text-black flex items-center justify-center">
                                            Pilih Paket
                                        </button>
                                    </div>
                                </div>
                                <div className="flex flex-col rounded-xl shadow-xs bg-gradient-to-b from-[#ffeaa4] to-white dark:from-[#111] dark:to-[#333] dark:text-gray-50 text-[#333] hover:shadow-2xl hover:shadow-black/20 backdrop-blur-md">
                                    <div className="flex items-center gap-2 text-xl p-6">
                                        ...
                                        <div>
                                            <p className="text-sm">Anggota</p>
                                            <h5 className="font-bold">Paket 1 Anggota</h5>
                                        </div>
                                    </div>
                                    <div className=" w-full px-6 flex-1">
                                        <p className="text-sm">Paket 1 Anggota.</p>
                                    </div>
                                    <div className="flex justify-between items-center p-6">
                                        <div className="flex justify-center">
                                            <span className="text-black dark:text-gray-50 font-bold">Rp. 1.099.000/Monograf</span>
                                        </div>
                                        <button onClick={() => showFormCustomer("1", "Paket 1 Anggota.")} className="w-fit font-bold py-2 px-4 rounded transition-colors bg-black dark:bg-black/80 dark:text-amber-500 dark:hover:text-amber-400 text-white hover:font-semibold text-sm hover:bg-transparent border border-transparent hover:border-black hover:text-black flex items-center justify-center">
                                            Pilih Paket
                                        </button>
                                    </div>
                                </div>
            ...
            </div>
            {
                showCustomer ? <div className="max-w-[1300px] mx-auto h-full pt-[80px]" id="shipping-information">
                    ...
                    <div className="flex flex-col gap-6 p-6">
                        <FormCustomer packName={packName} showAdress={showAdress} type={type} selectedPack={selected} />
                    </div>
                </div> : <></>
            }

            {
                (type === "pm") ? <div className="max-w-[1300px] mx-auto h-full pt-[0px]" id="shipping-information">
                    <header className="p-6">
                        <h1 className="max-md:text-xl md:text-2xl 2xl:text-4xl font-bold z-10 text-gray-700 dark:text-gray-50 leading-tight">Informasi Pemesanan</h1>
                        <p>{(type === "pm") ? "Program Penerbitan Mandiri" : "Program Menulis Buku Monograf"}</p>
                    </header>
                    <div className="flex flex-col gap-6 p-6">
