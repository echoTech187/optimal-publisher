    ...
    if (transactionStatusId === 1) {
        rightCardContent = (
            <div className="flex h-full w-full flex-col items-center justify-center">
                            ...
                            <p className="text-lg font-medium">Pesanan belum selesai.</p>
                            <p className="text-sm">Silahkan lanjutkan dengan menekan tombol di bawah ini untuk melanjutkan.</p>
                ...
                <div className="flex flex-col items-center justify-center text-gray-500 py-8 border border-dashed border-gray-300 rounded-lg">
                    {transaction.receipt_url ? (
                        <>
                            ...
                            <p className="text-lg font-medium">Resi Pembayaran</p>
                            <p className="text-sm text-gray-600">Tanggal: {transaction.receipt_date ? new Date(transaction.receipt_date).toLocaleDateString('id-ID') : 'N/A'}</p>
                        ...
                        <>
                            <Icon icon="ic:round-folder-open" className="w-12 h-12 mb-3" />
                            <p className="text-lg font-medium">Tidak ada dokumen yang tersedia.</p>
                            <p className="text-sm">Dokumen akan tersedia setelah pembayaran dikonfirmasi.</p>
                        </>
                    )}
                </div>
            </div>
                ...
                <div className="flex flex-col items-center justify-center text-gray-500 py-8 border border-dashed border-gray-300 rounded-lg">
                    {transaction.receipt_url || transaction.invoice_url ? (
                        <>
                            ...
                            {transaction.invoice_url && (
                                <div className="flex flex-col items-center">
                                    ...
                                    <p className="text-lg font-medium">Invoice Transaksi</p>
                        ...
                        <>
                            <Icon icon="ic:round-folder-open" className="w-12 h-12 mb-3" />
                            <p className="text-lg font-medium">Tidak ada dokumen yang tersedia.</p>
                            <p className="text-sm">Dokumen akan tersedia setelah transaksi selesai.</p>
                        </>
                    )}
                </div>
            </div>
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 min-h-screen bg-[#F4F7FE]">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8 pb-4 border-b border-gray-200">
                <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900">Detail Transaksi</h1>
                <div className="flex items-center gap-3">
                    <span className={`px-4 py-2 text-sm font-semibold rounded-full ${statusClasses}`}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white shadow-lg rounded-xl p-6">
                    <h2 className="text-2xl font-bold text-gray-900 mb-6">Informasi Transaksi</h2>
                    <div className="space-y-5">
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-gray-100 pb-3">
                            <div className="flex items-center gap-3 text-gray-600">
                                ...
                                <p className="text-base">Kode Transaksi</p>
                            </div>
                            <p className="text-base font-medium text-gray-900">{transaction.transaction_code}</p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-gray-100 pb-3">
                            <div className="flex items-center gap-3 text-gray-600">
                                ...
                                <p className="text-base">Nama Paket</p>
                            </div>
                            <p className="text-base font-medium text-gray-900">{transaction.pack_name}</p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-gray-100 pb-3">
                            ...
                            <p className="text-base font-medium text-gray-900">{String(transaction.transactionable?.title || transaction.transactionable?.book_title || 'N/A')}</p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-gray-100 pb-3">
                            ...
                            <p className="text-base font-semibold text-green-600">{new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR', minimumFractionDigits: 0 }).format(transaction.amount)}</p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-gray-100 pb-3">
                            ...
                            <p className="text-base font-medium text-gray-900">{transaction.payment_method?.name || 'N/A'}</p>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center border-b border-gray-100 pb-3">
                            <div className="flex items-center gap-3 text-gray-600">
                                ...
                                <p className="text-base">Tanggal Transaksi</p>
                            </div>
                            <p className="text-base font-medium text-gray-900">{new Date(transaction.created_at).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric', hour: '2-digit', minute: '2-digit' })}</p>
                        </div>
